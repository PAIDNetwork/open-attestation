...
describe("2.0 E2E Test Scenarios", () => {
  describe("Issuing a single documents", () => {
    ...
    test("should create a wrapped v2 document using did", async () => {
      const wrappedDocument = await wrapDocument({
        ...openAttestationDatav2,
        issuers: [
          {
    ...
    test("should create a wrapped v2 document using did-dns", async () => {
      const wrappedDocument = await wrapDocument({
        ...openAttestationDatav2,
        issuers: [
          {
  ...
  describe("obfuscation", () => {
    test("obfuscate data when there is one field to obfuscate", async () => {
      const newDocument = await wrapDocument({ key1: "value1", ...openAttestationDatav2 }, { version: SchemaId.v2 });
